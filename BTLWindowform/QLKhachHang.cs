...
namespace BTLWindowform
{
    public partial class QLKhachHang : Form
    {
        ...
        private void dvgKH_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            int i = dvgKH.CurrentRow.Index;
            txtMaKH.Text = dvgKH.Rows[i].Cells[0].Value.ToString();
            txtTenKH.Text = dvgKH.Rows[i].Cells[1].Value.ToString();
            if (dvgKH.Rows[i].Cells[2].Value.ToString() == "Nam")
            {
                radioButton1.Checked = true;
            }
            else
            ...
            if (dvgKH.Rows[i].Cells[2].Value.ToString() == "Nữ")
            {
                radioButton2.Checked = true;
            }
            else
            ...
            txtNgaySinh.Text = dvgKH.Rows[i].Cells[3].Value.ToString();
            txtDiaChi.Text = dvgKH.Rows[i].Cells[4].Value.ToString();
            txtSDT.Text = dvgKH.Rows[i].Cells[5].Value.ToString();
        }
