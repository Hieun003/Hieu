...
namespace BTLWindowform
{
    public partial class CTHDNhap : Form
    {
        ...
        {
            string s1 = "SELECT v_WarrantyNotExists.idWarranty,timeWarranty FROM v_WarrantyNotExists,tblWarranty WHERE v_WarrantyNotExists.idWarranty = tblWarranty.idWarranty";
