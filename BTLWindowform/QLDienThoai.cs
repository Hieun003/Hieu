...
namespace BTLWindowform
{
    public partial class QLDienThoai : Form
    {
        ...
        private void dgv_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            //cbHeDieuHanh.Text = dgv.Rows[i].Cells[3].Value.ToString();
            ...
            //cbDonGia.Text = dgv.Rows[i].Cells[11].Value.ToString();
        }
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            //{
                ...
                {
                    chung.executeCom("insert into tblDevice values ('"
        ...
        private void lbHeDieuHanh_Click(object sender, EventArgs e)
        {
